...
export function NavBar({ items, className }: NavBarProps) {
  ...
  return (
    <div
      className={cn(
        "fixed left-1/2 -translate-x-1/2 z-50 pointer-events-none bottom-4 sm:bottom-auto sm:top-4",
        className,
      )}
    >
      <div className="relative flex items-center gap-3 bg-background/5 border border-border backdrop-blur-lg py-1 px-1 rounded-full shadow-lg pointer-events-auto">
        {items.map((item) => {
